...
class ReciterCatalog {
  ...
  static const List<ReciterEntity> allReciters = [
    /*
    // --- 11 Reciters temporarily commented out ---
    ReciterEntity(
      id: 118,
      identifier: 'moataz_aghaei_tahdeer',
      name: 'استاد معتز آقایی (تحدیر)',
      englishName: 'Moataz Aghaei (Tahdeer)',
      arabicName: 'معتز آقایی',
      subfolder: 'http://dl.aviny.com/voice/quran/tahdir/{surah_2digit}.mp3,http://dl.anhar.ir/quran/tahdir/{surah_2digit}.mp3,http://dl.anhar.ir/audio/quran/tahdir/{surah_2digit}.mp3,http://sound.tebyan.net/music/quran/tahdir/{surah_2digit}.mp3,https://download.quran.ir/tahdir/aghaei/{surah}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'تحدیر',
      imageUrl: null,
    ...
    ReciterEntity(
      id: 113,
      identifier: 'hamed_shakernejad',
      name: 'استاد حامد شاکرنژاد',
      englishName: 'Hamed Shakernejad',
      arabicName: 'حامد شاكرنژاد',
      subfolder: 'https://server6.mp3quran.net/jamal/{surah}.mp3,http://dl.aviny.com/voice/quran/shakernejad/{surah_2digit}.mp3,http://dl.anhar.ir/quran/shakernejad/{surah_2digit}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    ReciterEntity(
      ...
      name: 'استاد شحات انور',
      englishName: 'Muhammad Anwar Shahat',
      arabicName: 'محمد أنور شحات',
      subfolder: 'ar.muhammadanwarshahat',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
    ...
    ReciterEntity(
      id: 110,
      identifier: 'emam_jomeh',
      name: 'استاد امام جمعه',
      englishName: 'Emam Jomeh',
      arabicName: 'محمدحسین امام جمعه',
      subfolder: 'http://dl.aviny.com/voice/quran/emamjomeh/{surah_2digit}.mp3,http://dl.anhar.ir/quran/emamjomeh/{surah_2digit}.mp3,https://download.quran.ir/emamjomeh/{surah}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    ReciterEntity(
      id: 112,
      identifier: 'pourzargari',
      name: 'استاد پورزرگری',
      englishName: 'Pourzargari',
      arabicName: 'عباس پورزرگری',
      subfolder: 'Purzargari_48kbps',
      bitrate: '48kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    ReciterEntity(
      id: 119,
      identifier: 'karim_mansoori',
      name: 'استاد کریم منصوری',
      englishName: 'Karim Mansoori',
      arabicName: 'کریم منصوری',
    ...
    ReciterEntity(
      ...
      name: 'استاد پناهی',
      englishName: 'Panahi',
      arabicName: 'استاد پناهی',
      subfolder: 'http://dl.aviny.com/voice/quran/panahi/{surah_2digit}.mp3,http://dl.anhar.ir/quran/panahi/{surah_2digit}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    ReciterEntity(
      ...
      name: 'استاد سبزعلی',
      englishName: 'Sabzali',
      arabicName: 'محمد سبزعلی',
      subfolder: 'http://dl.aviny.com/voice/quran/sabzali/{surah_2digit}.mp3,http://dl.anhar.ir/quran/sabzali/{surah_2digit}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    ReciterEntity(
      ...
      identifier: 'saeedian',
      name: 'استاد سعیدیان',
      englishName: 'Saeedian',
      arabicName: 'رحیم سعیدیان',
      subfolder: 'http://dl.aviny.com/voice/quran/saeedian/{surah_2digit}.mp3,http://dl.anhar.ir/quran/saeedian/{surah_2digit}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    ReciterEntity(
      ...
      name: 'استاد عباسی',
      englishName: 'Abbasi',
      arabicName: 'حسن عباسی',
      subfolder: 'http://dl.aviny.com/voice/quran/abbasi/{surah_2digit}.mp3,http://dl.anhar.ir/quran/abbasi/{surah_2digit}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    ReciterEntity(
      id: 117,
      identifier: 'misbahi_young',
      name: 'استاد مصباحی (قاری نوجوان)',
      englishName: 'Misbahi (Young Reciter)',
      arabicName: 'محمد مصباحی',
      subfolder: 'http://dl.aviny.com/voice/quran/misbahi/{surah_2digit}.mp3,http://dl.anhar.ir/quran/misbahi/{surah_2digit}.mp3',
      bitrate: '128kbps',
      styleId: 1,
      styleName: 'ترتیل',
      imageUrl: null,
    ...
    */
    ReciterEntity(
      id: 109,
      identifier: 'ibrahim_ahmad',
      name: 'استاد ابراهیم احمد',
      englishName: 'Ibrahim Ahmad',
      arabicName: 'إبراهيم أحمد',
    ...
    ReciterEntity(
      ...
      name: 'علی حجاج السویسی',
      englishName: 'Ali Hajjaj AlSuesy',
      arabicName: 'علی حجاج السویسی',
    ...
    ReciterEntity(
      ...
      name: 'ایمن سوید (64kbps)',
      englishName: 'Ayman Sowaid',
      arabicName: 'ایمن سوید',
    ...
    ReciterEntity(
      id: 203,
      identifier: 'en_sahih_walk',
      name: 'ترجمه انگلیسی (ابراهیم واک)',
      englishName: 'Sahih Int. - Ibrahim Walk (English)',
      arabicName: 'الترجمة الإنجليزية (إبراهيم واك)',
    ...
    ReciterEntity(
      id: 204,
      identifier: 'bs_besim_korkut',
      name: 'ترجمه بوسنیایی (بسیم کورکوت)',
      englishName: 'Besim Korkut (Bosnian)',
      arabicName: 'ترجمة البوسنية (بسام كوركوت)',
    ...
    ReciterEntity(
      id: 205,
      identifier: 'ur_farhat_hashmi',
      name: 'ترجمه اردو (فرهت هاشمی)',
      englishName: 'Farhat Hashmi (Urdu)',
      arabicName: 'ترجمة الأوردية (فرحت هاشمي)',
    ...
    ReciterEntity(
      id: 206,
      identifier: 'ur_shamshad_khan',
      name: 'ترجمه اردو (شمشاد علی خان)',
      englishName: 'Shamshad Ali Khan (Urdu)',
      arabicName: 'ترجمة الأوردية (شمشاد علي خان)',
